            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.uaes.index')}}">Visa Outbounds</a>
                        </li>
                        <li class="breadcrumb-item active">Add UAE Visa</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form id="demo-form2" method="POST" action="{{ route('admin.uaes.store') }}"
                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            <div class="card-header p-0 border-bottom-0">
                                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                    @if(Auth::guard('admin')->user()->hasRole('super-admin') || Auth::guard('admin')->user()->hasAllPermissions(['visa.uae.create.en','visa.uae.create.ar']))
                                        <?php
                                        $active_ar = '';
                                    ...
                                    @elseif (Auth::guard('admin')->user()->hasPermissionTo('visa.uae.create.en'))
                                        <?php
                                        $active_ar = '';
                                        $active_en = 'fade show active';
                                        ?>
                                    ...
                                    @elseif (Auth::guard('admin')->user()->hasPermissionTo('visa.uae.create.ar'))
                                        <?php
                                        $active_en = '';
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    @if (Auth::guard('admin')->user()->hasPermissionTo('visa.uae.create.en'))
                                    <div class="tab-pane fade {{$active_en}}" id="custom-tabs-four-home" role="tabpanel"
                                    ...
                                    @endif
                                    @if (Auth::guard('admin')->user()->hasPermissionTo('visa.uae.create.ar'))

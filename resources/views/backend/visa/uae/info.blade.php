...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit UAE Visa Global Information </h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form id="demo-form2" method="POST" action="{{ route('admin.visa.uae.info.save',$info->id) }}"
                                ...
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel"
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label>Type section title</label>
                                                <input class="form-control" type="text" name="title_section_1_en" value="{{$info->title_section_1_en}}">
                                            </div>
                                            <div class="form-group">
                                                <label>Nationality section title</label>
                                                <input class="form-control" type="text" name="title_section_2_en" value="{{$info->title_section_2_en}}">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                @if(isset($info->header_image_en))
                                                    <img style="width: 100px;"
                                                         src="{{ url('storage/app/public/images/info/'.$info->header_image_en) }}"/>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="custom-tabs-four-profile" role="tabpanel"
                                        ...
                                        <div class="col-md-8" style="direction: rtl;text-align: right;float: left">
                                            ...
                                            <div class="form-group">
                                                <label>عنوان قسم الأنواع</label>
                                                <input class="form-control" type="text" name="title_section_1_ar" value="{{$info->title_section_1_ar}}">
                                            </div>
                                            <div class="form-group">
                                                <label>عنوان قسم التأشيرات</label>
                                                <input class="form-control" type="text" name="title_section_2_ar" value="{{$info->title_section_2_ar}}">
                                            </div>
                                            <div class="form-group">

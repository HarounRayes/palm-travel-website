...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Add UAE Visa Nationality </h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form id="demo-form2" method="POST" action="{{ route('admin.uaeNationalities.store') }}"
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="radioPrimary2" checked name="is_visa" value="0"
                                                   onclick="visaVisibility(this.value)">
                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header p-0 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                @if(Auth::guard('admin')->user()->hasRole('super-admin') || Auth::guard('admin')->user()->hasAllPermissions(['visa.uae.nationalities.create.en','visa.uae.nationalities.create.ar']))
                                    <?php
                                    $active_ar = '';
                                ...
                                @elseif (Auth::guard('admin')->user()->hasPermissionTo('visa.uae.nationalities.create.en'))
                                    <?php
                                    $active_ar = '';
                                    $active_en = 'fade show active';
                                    ?>
                                ...
                                @elseif (Auth::guard('admin')->user()->hasPermissionTo('visa.uae.nationalities.create.ar'))
                                    <?php
                                    $active_en = '';
                    ...
                    <div class="card card-primary card-outline card-outline-tabs visa-type" style="display: none">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group" id='hotel-of-country'>
                                        <div class="row">
                                            <div class="col-sm-11">
                                                @if($types)
                                                    <select class="form-control select2bs4" id="type_id"
                                                            style="width: 100%;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" id="div-container-type"></div>
                                </div>
                            </div>
                        </div>
                    </div>

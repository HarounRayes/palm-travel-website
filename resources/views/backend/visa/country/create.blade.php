    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form id="demo-form2" method="POST" action="{{ route('admin.visacountries.store') }}"
                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            <div class="card-header p-0 border-bottom-0">
                                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                    @if(Auth::guard('admin')->user()->hasRole('super-admin') || Auth::guard('admin')->user()->hasAllPermissions(['visa.countries.create.en','visa.countries.create.ar']))
                                        <?php
                                        $active_ar = '';
                                    ...
                                    @elseif (Auth::guard('admin')->user()->hasPermissionTo('visa.countries.create.en'))
                                        <?php
                                        $active_ar = '';
                                        $active_en = 'fade show active';
                                        ?>
                                    ...
                                    @elseif (Auth::guard('admin')->user()->hasPermissionTo('visa.countries.create.ar'))
                                        <?php
                                        $active_en = '';
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    @if (Auth::guard('admin')->user()->hasPermissionTo('visa.countries.create.en'))
                                    ...
                                    @endif
                                    @if (Auth::guard('admin')->user()->hasPermissionTo('visa.countries.create.ar'))

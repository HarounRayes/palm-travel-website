                ...
                <div class="float-left col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{route('admin.tours.index',['country' => $tour->country->id])}}">Tours of
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form id="demo-form2" method="POST" action="{{ route('admin.tours.update' ,$tour->id) }}"
                    ...
                    <div class="col-12 float-left col-sm-12">
                        <div class="card card-primary card-outline card-outline-tabs">
                            ...
                            <div class="form-group">
                                <?php
                                if (isset($tour->is_car) && $tour->is_car == '1') {
                                    $checked_car = 'checked';
                                } else {
                                    $checked_car = '';
                                }
                                ...
                                <div class="float-left col-sm-1">
                                    <input type="checkbox" {{$checked_car}} class="form-control" name="is_car" value='1'
                            ...
                            <div class="form-group">
                                <?php
                                if (isset($tour->is_bus) && $tour->is_bus == '1') {
                                    $checked_bus = 'checked';
                                } else {
                                    $checked_bus = '';
                                }
                                ?>
                                <div class="float-left col-sm-1">
                                    <input type="checkbox" {{$checked_bus}} class="form-control" name="is_bus" value='1'
                                           style="margin-top:40px;"/>
                                </div>
                                <div class="float-left col-sm-2">
                                    <label for="disabledinput" class="control-label">
                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    @if (Auth::guard('admin')->user()->hasPermissionTo('tours.edit.en'))
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="textarea" name="text_en"
                                                              style="max-width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$tour->text_en}}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    @if(isset($tour->image_en))
                                                        <img style="width: 100px;"
                                                             src="{{ url('storage/app/public/images/tour/'.$tour->image_en) }}"/>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    @if (Auth::guard('admin')->user()->hasPermissionTo('tours.edit.ar'))
                                            ...
                                            <div class="col-md-8" style="direction: rtl;text-align: right;float: left">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="textarea" name="text_ar"
                                                              style="max-width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$tour->text_ar}}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    @if(isset($tour->image_ar))
                                                        <img style="width: 100px;"
                                                             src="{{ url('storage/app/public/images/tour/'.$tour->image_ar) }}"/>
                                                    @endif
                                                </div>
                                            </div>

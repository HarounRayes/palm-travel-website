            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">ُEdit Country</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form id="demo-form2" method="POST" action="{{ route('admin.countries.update', $country->id) }}"
                                ...
                                <div class="col-6 col-md-6" style="float: left">
                                    ...
                                    @if(isset($country->flag))
                                        <img style="width: 100px;"
                                             src="{{ url('storage/app/public/images/country/'.$country->flag) }}"/>
                                    @endif
                                </div>
                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            <div class="card-header p-0 border-bottom-0">
                                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                    @if(Auth::guard('admin')->user()->hasRole('super-admin') || Auth::guard('admin')->user()->hasAllPermissions(['countries.edit.en','countries.edit.ar']))
                                        <?php
                                        $active_ar = '';
                                    ...
                                    @elseif (Auth::guard('admin')->user()->hasPermissionTo('countries.edit.en'))
                                        <?php
                                        $active_ar = '';
                                        $active_en = 'fade show active';
                                        ?>
                                    ...
                                    @elseif (Auth::guard('admin')->user()->hasPermissionTo('countries.edit.ar'))
                                        <?php
                                        $active_en = '';
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    @if (Auth::guard('admin')->user()->hasPermissionTo('countries.edit.en'))
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="capital_en" class="form-control"
                                                           value="{{$country->capital_en}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Currency</label>
                                                    <input type="text" name="currency_en" class="form-control"
                                                           value="{{$country->currency_en}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Convert Currency</label>
                                                    <input type="text" name="convert_currency_en" class="form-control"
                                                           value="{{$country->convert_currency_en}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Official Language</label>
                                                    <input type="text" name="official_lang_en" class="form-control"
                                                           value="{{$country->official_lang_en}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Visa Information</label>
                                                    <textarea class="textarea" name="visa_info_en"
                                                              style="max-width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> {{$country->visa_info_en}}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>Introduction Text</label>
                                                    <textarea class="textarea" name="intro_en"
                                                              style="max-width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$country->intro_en}}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    @if(isset($country->image_en))
                                                        <img style="width: 100px;"
                                                             src="{{ url('storage/app/public/images/country/'.$country->image_en) }}"/>
                                                    @endif
                                                </div>
                                                <div class="form-group">
                                    ...
                                    @endif
                                    @if (Auth::guard('admin')->user()->hasPermissionTo('countries.edit.ar'))
                                            ...
                                            <div class="col-md-8" style="direction: rtl;text-align: right;float: left">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="convert_currency_ar" class="form-control"
                                                           value="{{$country->convert_currency_ar}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>اللغة الرسمية</label>
                                                    <input type="text" name="official_lang_ar" class="form-control"
                                                           value="{{$country->official_lang_ar}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>معلومات التأشيرة</label>
                                                    <textarea class="textarea" name="visa_info_ar"
                                                              style="max-width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$country->visa_info_ar}}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>نص المقدمة</label>
                                                    <textarea class="textarea" name="intro_ar"
                                                              style="max-width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$country->intro_ar}}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    @if(isset($country->image_ar))
                                                        <img style="width: 100px;"
                                                             src="{{ url('storage/app/public/images/country/'.$country->image_ar) }}"/>
                                                    @endif
                                                </div>
                                                <div class="form-group">

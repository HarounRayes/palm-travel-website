        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="float-left col-sm-6">
                    <h1>Add Slider to ({{$package->name_en}})</h1>
                </div>
                <div class="float-left col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{route('admin.packages.sliders.index',['package' => $package->id])}}">Sliders </a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form id="demo-form2" method="POST" action="{{ route('admin.packages.sliders.store',['package' => $package->id]) }}"

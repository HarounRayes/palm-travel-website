...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Activity Global Information </h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form id="demo-form2" method="POST" action="{{ route('admin.activity.info.save',$info->id) }}"
                        ...
                        <div class="col-4 col-md-4">
                            <div class="card card-primary card-outline card-outline-tabs">
                                <div class="card-header">
                                    <h4>Enable Checkout</h4>
                                </div>
                                <div class="card-body">
                                    @if($activity_checkout->status == '1')
                                        <input id="activity-checkout-switch" type="checkbox" name="activity_checkout"
                                               checked

    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form id="demo-form2" method="POST" action="{{ route('admin.sliders.store') }}" enctype="multipart/form-data" style="width: 100%">
                    @csrf
                                ...
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                        <div class="col-md-8" >
                                            ...
                                            <div class="form-group" >
                                                <label>Link</label>
                                                <input type="text" name="link_en" class="form-control">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="tab-pane" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                        ...
                                        <div class="col-md-8" style="direction: rtl;text-align: right;float: left">
                                            ...
                                            <div class="form-group" >
                                                <label>الرابط</label>
                                                <input type="text" name="link_ar" class="form-control">
                                            </div>
                                            <div class="form-group">

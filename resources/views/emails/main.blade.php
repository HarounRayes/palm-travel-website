...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #fff; direction:ltr;">
<!--[if IE]>
<div class="ie-browser"><![endif]-->
<table bgcolor="#fff" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
       style="table-layout: fixed; vertical-align: top; min-width: 320px; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fff; width: 100%;"
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div align="center" class="img-container center fixedwidth"
                                        ...
                                        <![endif]--><img align="center" alt="Alternate text" border="0"
                                                         ...
                                                         src="https://palmoasistravel.com/img/email-header.PNG"
                                                         style="text-decoration: none; -ms-interpolation-mode: bicubic;  border: 0;width: 100%; display: block;"
                                                         title="Alternate text" width="600"/>
                            ...
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div align="center" class="img-container center fixedwidth"
                                        ...
                                        <![endif]--><img align="center" alt="Alternate text" border="0"
                                                         class="center fixedwidth"
                                                         src="https://palmoasistravel.com/img/email-footer.PNG"
                                                         style="text-decoration: none; -ms-interpolation-mode: bicubic;  border: 0;width: 100%; display: block;"
                                                         title="Alternate text" width="600"/>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
